...
# 科学上网插件
git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall.git;main package/psw
git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall-packages.git;main package/pswcore
